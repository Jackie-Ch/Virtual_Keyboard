...
const capsLockIndicatorBox = document.createElement('div');
capsLockIndicatorBox.classList.add('capslock-box');
capsLockIndicatorBox.textContent = 'Caps Lock indicator';

const capsLockIndicator = document.createElement('div');
capsLockIndicator.classList.add('capslock-indicator');

capsLockIndicatorBox.prepend(capsLockIndicator);

const languageBox = document.createElement('div');
languageBox.textContent = 'смена языка CtrlLeft + AltLeft / OS Windows';
...
root.append(capsLockIndicatorBox, textArea, keyBox, languageBox);
